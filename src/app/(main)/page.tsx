            ...
            {[
              {
                ...
                title: t.home.benefits.strengthTitle,
                description: t.home.benefits.strengthDesc
              },
              {
                icon: <Target className="w-8 h-8" />,
                title: t.home.benefits.bodyTitle,
                description: t.home.benefits.bodyDesc
              },
              {
                icon: <Award className="w-8 h-8" />,
                title: t.home.benefits.equipmentTitle,
                description: t.home.benefits.equipmentDesc
              },
              {
                icon: <TrendingUp className="w-8 h-8" />,
                title: t.home.benefits.progressiveTitle,
                description: t.home.benefits.progressiveDesc
              },
              {
                icon: <Users className="w-8 h-8" />,
                title: t.home.benefits.communityTitle,
                description: t.home.benefits.communityDesc
              },
              {
                icon: <Clock className="w-8 h-8" />,
                title: t.home.benefits.anytimeTitle,
                description: t.home.benefits.anytimeDesc
              }
            ].map((benefit, index) => (
              <motion.div
                key={index}
      ...
      <section className="py-20 bg-card/30">
        <div className="container mx-auto px-4">
          ...
          >
            {[
              {
                name: t.home.sections.tutorialsTitle,
                description: t.home.sections.tutorialsDesc,
                href: '/tutorials'
              },
              {
                name: t.home.sections.aiTrainingTitle,
                description: t.home.sections.aiTrainingDesc,
                href: '/training'
              },
              {
                name: t.home.sections.skillTreeTitle,
                description: t.home.sections.skillTreeDesc,
                href: '/skill-tree'
              },
              {
                name: t.home.sections.terminologyTitle,
                description: t.home.sections.terminologyDesc,
                href: '/terminology'
              }
            ].map((page, index) => (
              <motion.div
              ...
              >
                ...
                >
                  {t.home.sections.exploreButton} <ArrowRight className="w-4 h-4" />
                </Link>
              </motion.div>
            ))}
          </motion.div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-6">{t.home.skills.title}</h2>
            ...
            {[
              ...
              <Link href={skill.link} key={index}>
                ...
                >
                  ...
                  <div className="text-sm text-foreground/60">{t.home.skills.difficulty}: {skill.difficulty}</div>
                </motion.div>
              </Link>
            ))}
          </motion.div>
