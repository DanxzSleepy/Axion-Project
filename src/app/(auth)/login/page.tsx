        ...
        <div className="p-8 bg-card border border-border rounded-2xl">
          ...
          <div className="mt-6">
            ...
            <button
              ...
              className="mt-4 w-full py-3 bg-background border border-border hover:border-primary rounded-lg transition-all flex items-center justify-center gap-2 disabled:opacity-50"
            >
